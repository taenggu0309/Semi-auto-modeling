...
def get_scorecard_model(train_data,test_data,target,nan_value=-999,score=400,odds=999/1,pdo=20):
    ...
    trim_bin_list=[]
    for col in tqdm(trim_var_dict.keys()):
    ...
    score_map_df  = get_score_map(woe_map_df2,coe_dict,B)
    # 分数映射
    ...
    return lr_model,score_map_df,valid_score,test_score,valid_pre,A,B,x_valid